...
- [/] **P1: NousResearch Hermes-Agent 替代 Google ADK 技術評估與遷移計畫**
    - **對照計劃書生成**：編寫並發布 [implementation_plan.md](file:///home/hi6688/.gemini/antigravity-ide/brain/f507483e-b47b-4903-9965-cc19ca3fcfd4/implementation_plan.md)，詳列 Discord 傳輸、GenAI SDK、記憶（mem0）、內建 Loop 與遙測系統的參數對照表。
    - **環境隔離與部署**：於 `/home/hi6688/servers/venv_hermes` 部署獨立的 `hermes-agent` 執行沙盒。
